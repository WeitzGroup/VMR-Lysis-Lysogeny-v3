...
text(XX,h_m*MAX,paste("slope = ", round(coef(PP_MODEL)[2],ROUND)),pos=4)
...
text(XX,h_m*MAX,paste("slope = ", round(coef(INT_MODEL)[2],ROUND)),pos=4)
...
text(XX,h_m*MAX,paste("slope = ", round(coef(EXC_MODEL)[2],ROUND)),pos=4)
